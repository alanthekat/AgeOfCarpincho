...
alan <- paste("https://aoe2.net/api/player/ratinghistory?game=aoe2de&leaderboard_id=3&steam_id=76561199207580572&count=1000")
alanhr <- GET(alan)
...
dicopato <- paste("https://aoe2.net/api/player/ratinghistory?game=aoe2de&leaderboard_id=3&steam_id=76561199195740571&count=1000")
...
nano <- paste("https://aoe2.net/api/player/ratinghistory?game=aoe2de&leaderboard_id=3&steam_id=76561198191637438&count=1000")
nanohr <- GET(nano)
...
mono <- paste("https://aoe2.net/api/player/ratinghistory?game=aoe2de&leaderboard_id=3&steam_id=76561198163778606&count=1000")
monohr <- GET(mono)
...
kato <- paste("https://aoe2.net/api/player/ratinghistory?game=aoe2de&leaderboard_id=3&steam_id=76561198153797281&count=1000")
katohr <- GET(kato)
...
parkopato <- paste("https://aoe2.net/api/player/ratinghistory?game=aoe2de&leaderboard_id=3&steam_id=76561198118459931&count=1000")
...
saveWidget(fig, "Elo_Chart1v1.html", selfcontained = F, libdir = "lib")
